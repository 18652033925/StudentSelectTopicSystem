    ...
    <div id="wrapper">
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<%
						...
						List<TopicInfo> topicInfos = (List<TopicInfo>) request.getAttribute("communication");
						int n = 1;
						String str1;
						String str2;
						String btn;
		...
		<ul class="pagination">
			<%
				...
				int num = 20; //一页显示20条
				int count = (int) request.getAttribute("num_communication");
				int pageCount = count / num + 1; //计算有共有多少页
				if (p != 1) {
					out.print("<li><a href='index_communication.action?page=" + (p - 1) + "'>上一页</a></li>");
				}
				for (int i = 1; i <= pageCount; i++) {
					if (i == p) {
						out.print("<li><a href='index_communication.action?page=" + i + "' style='background-color: #ccc;'>" + i + "</a></li>");
						continue;
					}
					out.print("<li><a href='index_communication.action?page=" + i + "'>" + i + "</a></li>");
				}
				if (p != pageCount) {
					out.print("<li><a href='index_communication.action?page=" + (p + 1) + "'>下一页</a></li>");
				}
			%>
		</ul>
        </div>
